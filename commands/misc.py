...
def register(router):
    ...
    def credits(ctx):
        ctx.reply(
            "致谢 Credits\n"
            "\n"
            "BoB 是完全开源的 hack.chat 机器人，运行在 hack.chat 平台上。\n"
            "感谢 hack.chat 官方开源服务器端代码，\n"
            "也感谢 Awaya(阿瓦娅) 在 21 点、红包等功能上的灵感。(・∀・)\n"
            "\n"
            "BoB 开源仓库：https://github.com/alltobebetter/BoBot\n"
            "欢迎 Star / Issue / PR，一起优化 BoB！\n"
